    ...
    <div className={styles.container}>
      ...
      <div className={styles.offer_container}>
        ...
        <ul className={styles.check_section}>
          <li><IoCheckbox /> 70 artes para o Feed</li>
          <li><IoCheckbox /> 50 artes para Stories</li>
          <li><IoCheckbox /> 20 Capa de Destaque</li>
          <li><IoCheckbox /> Mini Curso Canva</li>
          <li><IoCheckbox /> Bônus Paleta de cores</li>
          <li><IoCheckbox /> Bônus Legendas prontas</li>
          <li><IoCheckbox /> Bônus Calendário de conteúdo</li>
        </ul>
        <p>
            de <span className={styles.line_through}>R$ 159,90</span> por apenas
        </p>
        <p className={styles.offer_price}>
            6x de <span className={styles.secondary_background_color}>R$ 6,99*</span>
        </p>
        <p>
